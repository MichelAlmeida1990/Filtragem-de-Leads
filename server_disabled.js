...
// Middleware para configurar Content-Type correto
app.use((req, res, next) => {
    // Configurar Content-Type baseado na extensão do arquivo
...
app.post('/api/upload-excel', upload.single('excelFile'), (req, res) => {
    try {
        ...
        // Converter para string CSV com UTF-8 e formatação correta
