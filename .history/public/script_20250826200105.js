...
window.toggleBackgroundAnimation = function() {
    ...
    if (backgroundAnimationEnabled) {
        ...
        window.showNotification('Animação de fundo desativada! ✨', 'info');
    } else {
        // Ligar animação
        ...
        window.showNotification('Animação de fundo ativada! ✨', 'success');
    }
};
...
window.toggleBannerAnimation = function() {
    ...
    if (bannerAnimationEnabled) {
        ...
        window.showNotification('Banner estático ativado! 📌', 'info');
    } else {
        banner.classList.add('active');
        bannerAnimationEnabled = true;
        btn.textContent = '📌 Fixar';
        window.showNotification('Banner animado ativado! 🎭', 'success');
    }
};

window.showMarketInfo = function() {
    const marketData = [
