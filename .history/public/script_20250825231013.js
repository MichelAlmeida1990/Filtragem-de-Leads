document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateFilters() {
        ...
        // Find city and area columns - procurar por colunas que contenham os valores MAUA/SP
        let cityColumn = null;
        let areaColumn = null;
        ...
        headers.forEach((header, index) => {
            ...
            console.log(`Coluna "${header}":`, uniqueValues.slice(0, 5)); // Mostrar primeiros 5 valores únicos
            
            // Se a coluna contém MAUA ou SP, é a coluna de cidade
            if (uniqueValues.some(val => val === 'MAUA' || val === 'SP')) {
                cityColumn = header;
            ...
            if (uniqueValues.some(val => val && val.toString().startsWith('ROTA'))) {
                areaColumn = header;
                console.log('Coluna de área/rota encontrada:', header);
            }
        ...
        if (areaColumn) {
            // Pegar todos os valores únicos da coluna de área
    ...
    function applyFilters() {
        ...
        // Encontrar colunas de cidade e área usando a mesma lógica
        let cityColumn = null;
        let areaColumn = null;
        ...
        console.log('Aplicando filtros - Coluna cidade:', cityColumn, 'Coluna área:', areaColumn);
    ...
    function exportToPdf() {
        ...
        const csvContent = formatDataForDisplay(filteredData);
        downloadFile(csvContent, 'dados_filtrados.pdf', 'application/pdf');
